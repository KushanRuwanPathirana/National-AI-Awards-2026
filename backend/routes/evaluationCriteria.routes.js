...
const { getCriteria, getCriteriaById, createCriteria, updateCriteria, deleteCriteria, seedDefaultCriteria } = require('../controllers/evaluationCriteria.controller');

router.get('/', getCriteria);
router.get('/:id', getCriteriaById);
router.post('/seed', authenticate, requireRole('admin'), seedDefaultCriteria);
