      ...
      <header className="bg-navy-950/80 backdrop-blur-md border-b border-white/10 py-5">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display font-bold text-white text-base leading-tight">Admin Portal</h1>
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto px-4 py-10 grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="glass-card p-2 space-y-1 !hover:transform-none">
            {[
              ...
              { id: 'manage-nominations', label: 'All Nominations', icon: RiFileList3Line },
              { id: 'manage-users', label: 'User Directory', icon: RiTeamLine },
              { id: 'settings', label: 'System Settings', icon: RiSettings4Line },
        ...
        <div className="lg:col-span-3">
          ...
          >
            ...
            {/* 2. ALL NOMINATIONS TAB */}
            {activeTab === 'manage-nominations' && (
              <div>
                <h3 className="font-display font-bold text-white text-xl mb-2">Submitted Applications</h3>
                <p className="text-slate-400 text-sm mb-6">Track and oversee all candidate applications submitted to the panel.</p>
                ...
                <div className="border border-dashed border-white/10 rounded-2xl p-10 text-center">
                  ...
                  <p className="text-slate-500 text-xs">Candidates have not yet started submitting their nomination forms.</p>
                </div>
              </div>
            )}
            ...
            {activeTab === 'manage-users' && (
              <div>
                <h3 className="font-display font-bold text-white text-xl mb-2">User Directory</h3>
                <p className="text-slate-400 text-sm mb-6">Manage all candidate, judge, and admin accounts registered in the system.</p>

                {/* Empty State */}
                <div className="border border-dashed border-white/10 rounded-2xl p-10 text-center">
                  <h4 className="font-display font-semibold text-white text-base mb-1">Directory Empty</h4>
                  <p className="text-slate-500 text-xs">Database users list will load here during upcoming dashboard integration phases.</p>
                </div>
              </div>
            )}
            ...
            {activeTab === 'settings' && (
              <div>
                <h3 className="font-display font-bold text-white text-xl mb-2">System Configuration</h3>
                <p className="text-slate-400 text-sm mb-6">Manage key timelines, system status, and file limit parameters.</p>

                {/* Empty State */}
                <div className="border border-dashed border-white/10 rounded-2xl p-10 text-center">
                  <h4 className="font-display font-semibold text-white text-base mb-1">Configuration Locked</h4>
                  <p className="text-slate-500 text-xs">System variables panel will be wired to backend config controllers in Phase 2.</p>
                </div>
              </div>
            )}
