          ...
          >
            ...
            {activeTab === 'password' && (
              <div>
                ...
                <p className="text-slate-400 text-sm mb-6">Ensure your account uses a secure password.</p>
                ...
                <form onSubmit={handleSubmit(onChangePasswordSubmit)} className="space-y-4 max-w-md">
                  {[
                    ...
                    <div key={f.field}>
                      ...
                      {errors[f.field] && <p className="text-red-400 text-xs mt-1">{errors[f.field].message}</p>}
                    </div>
                  ))}
                  <div>
                  ...
                  <button id="change-submit" type="submit" disabled={isSubmitting} className="btn-primary w-full mt-2"
