...
import {
  ...
  RiSendPlane2Line, RiCheckDoubleLine, RiFileList3Line, RiShieldUserLine,
} from 'react-icons/ri';
      ...
      <header className="bg-navy-950/80 backdrop-blur-md border-b border-white/10 py-5">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display font-bold text-white text-base leading-tight">Candidate Portal</h1>
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="glass-card p-2 space-y-1 !hover:transform-none">
            {[
              ...
              { id: 'nominations', label: 'My Nominations', icon: RiFileList3Line },
        ...
        <div className="lg:col-span-3">
          ...
          >
            ...
            {activeTab === 'nominations' && (
              <div>
                <h3 className="font-display font-bold text-white text-xl mb-2">My Nominations</h3>
                <p className="text-slate-400 text-sm mb-6">Create, edit, and submit your entries for the AI Awards Sri Lanka 2026.</p>
                ...
                <div className="border border-dashed border-white/10 rounded-2xl p-10 text-center">
                  ...
                  <h4 className="font-display font-semibold text-white text-base mb-1">No Nominations Yet</h4>
